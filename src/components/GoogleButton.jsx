export default function GoogleButton() {
  return(
    <button
    className="border rounded-sm h-12 pr-3 flex cursor-pointer items-center font-roboto text-center bg-white
    text-[#1f1f1f] justify-between font-medium hover:bg-[#303030]/8 transition-all duration-218 border-[#747775]
